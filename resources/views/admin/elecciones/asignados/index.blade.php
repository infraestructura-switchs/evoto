    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title">LISTADO DE GRUPOS | <a href="{{ route('eleccion.asignados.create') }}"><button type="button" class="btn btn-icon btn-info btn-sm" data-toggle="tooltip" data-original-title="Crear Nuevo"><i class="la la-plus"></i></button></a> </h4>
                ...
                <tr>
                  ...
                  <td>
                    <a href="" data-target="#modal-show-{{$gru->id}}" data-toggle="modal">
                      ...
                      <a href="{{ route('asignados.edit', $gru->id) }}">
                    ...
                    @include('admin.elecciones.asignados.modal')
                    @include('admin.elecciones.asignados.show')
                    @endforeach
