            ...
            <table class="table table-striped table-bordered zero-configuration">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td align="ccaner">
                    @if($can->foto)
                    <img src="{{ $can->foto }}" class="gallery-thumbnail card-img-top responsive" width="40px" >
                    @endif
                  </td>
                   <td>
                    ...
                    @include('admin.elecciones.candidatos.modal')
                    @include('admin.elecciones.candidatos.show')
                    @endforeach
