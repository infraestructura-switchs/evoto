  ...
  <div class="row">
    <div class="col-12">
      <div class="card">
          ...
          <h4 class="card-title">LISTADO DE ASPIRANTES | <a href="{{ route('aspirantes.create') }}"><button type="button" class="btn btn-icon btn-info btn-sm" data-toggle="tooltip" data-original-title="Crear Nuevo"><i class="la la-plus"></i></button></a> </h4>
                  ...
                  <td align="ccaner">
                   ...
                   <td>
                    ...
                    <a href="" data-target="#modal-show-{{$can->id}}" data-toggle="modal">
                      ...
                      <a href="" data-target="#modal-validar-{{$can->id}}" data-toggle="modal">

                      <button type="button" class="btn btn-icon btn-info btn-sm box-shadow-1"  data-toggle="tooltip" data-original-title="Validar"><i class="la la-check"></i></button></a>

                      <a href="{{ route('aspirantes.edit', $can->id) }}">
                    ...
                    @include('admin.elecciones.aspirantes.modal')
                    @include('admin.elecciones.aspirantes.show')
                    @include('admin.elecciones.aspirantes.validar')
                    @endforeach
