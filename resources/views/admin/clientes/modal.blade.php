 <div class="modal animated bounceInRight text-left" id="modal-delete-{{ $cli->id }}" tabindex="-1"
 	role="dialog" aria-labelledby="myModalLabel49" aria-hidden="true">
 	<div class="modal-dialog" role="document" >
 		<div class="modal-content">
 			<div class="modal-header bg-danger white">
 				<h4 class="modal-title" id="myModalLabel49">Eliminar Cliente</h4>
 			...
 			<div class="modal-footer">
 				{!! Form::open(['route' => ['clientes.destroy', $cli->id], 'method' => 'DELETE']) !!}
