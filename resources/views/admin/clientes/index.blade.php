    ...
    <div class="col-12">
      <div class="card">
        <div class="card-header">
          <h4 class="card-title">LISTADO DE CLIENTES | <a href="{{ route('clientes.create') }}"><button type="button" class="btn btn-icon btn-info btn-sm" data-toggle="tooltip" data-original-title="Crear Nuevo"><i class="la la-plus"></i></button></a> </h4>
            ...
            <table class="table table-striped table-bordered zero-configuration">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>
                    <a href="" data-target="#modal-show-{{$cli->id}}" data-toggle="modal">
                      ...
                      <a  data-target="#modal-delete-{{ $cli->id }}" data-toggle="modal">
