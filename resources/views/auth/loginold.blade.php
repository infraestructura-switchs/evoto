...
<head>
  ...
  <link rel="apple-touch-icon" href="{{asset('logos/vt.png')}}">
  <link rel="shortcut icon" type="image/x-icon" href="{{asset('logos/vt.png')}}">
              ...
              <div class="card border-grey border-lighten-3 m-0">
                <div class="card-header border-0">
                  <div class="card-title text-center">
                    <div class="p-1"> 
                      <img src="{{asset('logos/vt.png')}}" alt="branding logo">
                    </div>
                  </div>
                ...
                <div class="card-footer">
                  <a class="btn btn-block btn-social btn-google" href="{{ url('auth/google') }}">
                    <i class="la la-google"></i> Iniciar sesión correo Institucional
                  </a>
                </div>
              </div>
            </div>
